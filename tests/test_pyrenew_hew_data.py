...
def test_from_json(tmp_path, fit_ed_visits, fit_hospital_admissions, fit_wastewater):
    """
    ...
    """
    # Create mock data
    mock_data = _build_mock_data(fit_ed_visits, fit_hospital_admissions, fit_wastewater)
